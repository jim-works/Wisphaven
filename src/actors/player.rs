...
pub fn spawn_local_player(
    ...
    let player_id = commands.spawn((
        ...
        let grass_item = items::create_item(Item::new("Grass Block".into(), 999), ItemIcon(assets.load("textures/items/grass_block.png")), BlockItem(block_resources.registry.get_id(&BlockName::core("grass"))), &mut commands);
