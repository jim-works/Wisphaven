...
pub fn spawn_local_player(
    ...
    let player_id = commands.spawn((
        ...
        let grass_item = items::create_item(Item::new("Grass Block".into(), 999), ItemIcon(assets.load("textures/items/grass_block.png")), BlockItem(block_resources.registry.id_map.get(&BlockName::core("grass")).copied().unwrap()), &mut commands);
