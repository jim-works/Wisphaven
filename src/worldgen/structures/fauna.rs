...
impl StructureGenerator for FauanaGenerator {
    ...
    fn generate(&self, buffer: &mut crate::world::BlockBuffer<BlockId>, world_pos: crate::world::BlockCoord, local_pos: ChunkIdx, chunk: &crate::world::chunk::GeneratingChunk) -> bool {
