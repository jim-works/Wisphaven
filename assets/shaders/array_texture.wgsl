...
//texture array layer is x coordinate, ao level is y coordinate
    ...
    @location(6) ao: f32,
    //built in bevy stuff - uses locations 0-4
...
fn fragment(in: VertexOutput, @builtin(front_facing) is_front: bool) -> @location(0) vec4<f32> {
    ...
    if ((pbr_bindings::material.flags & pbr_types::STANDARD_MATERIAL_FLAGS_BASE_COLOR_TEXTURE_BIT) != 0u) {
        let layer = in.layer;
        output_color = output_color * textureSampleBias(array_color_texture, array_color_texture_sampler, uv, in.layer, view.mip_bias);
    }
#endif
    ...
    if ((pbr_bindings::material.flags & pbr_types::STANDARD_MATERIAL_FLAGS_UNLIT_BIT) == 0u) {
        ...
        //     emissive = vec4<f32>(emissive.rgb * textureSampleBias(array_emissive_texture, array_emissive_texture_sampler, uv, in.layer, view.mip_bias).rgb, 1.0);
        // }
#endif
        ...
        //     let metallic_roughness = textureSampleBias(array_metallic_roughness_texture, array_metallic_roughness_texture_sampler, uv, in.layer, view.mip_bias);
        ...
        //     occlusion = vec3(textureSampleBias(array_occlusion_texture, array_occlusion_texture_sampler, uv, in.layer, view.mip_bias).r);
        // }
#endif
#ifdef SCREEN_SPACE_AMBIENT_OCCLUSION
