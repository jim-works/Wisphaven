...
fn update_calendar(
    ...
    match calendar.eternal_night {
        false => calendar.advance(inc, &mut day_writer, &mut night_writer),
        true => calendar.advance_eternal_night(inc, &mut night_writer),
    };
}
