...
#[derive(Component)]
pub(crate) struct StructureTask {
    pub task: Task<(ChunkCoord, BlockBuffer<BlockId>)>,
}

#[derive(Component)]
pub(crate) struct LODShapingTask {
...
#[derive(Component)]
pub(crate) struct GeneratedLODChunk;

#[derive(Clone)]
pub(crate) struct Heightmap<const SIZE: usize>(pub [[f32; SIZE]; SIZE]);
#[derive(Clone)]
pub(crate) struct ColumnBiomes<const SIZE: usize>(pub [[Option<usize>; SIZE]; SIZE]);
...
impl OreGenerator {
    pub(crate) fn get_ore_placement(&self, rng: u64) -> Option<ChunkIdx> {
...
pub(crate) fn poll_shaping_task(
    mut commands: Commands,
...
pub(crate) fn poll_decoration_waiters(
...
pub(crate) fn poll_decoration_task(
    mut commands: Commands,
...
pub(crate) fn poll_structure_waiters(
    decor_resources: Res<DecorationResources>,
    level: Res<Level>,
    mut commands: Commands,
...
pub(crate) fn poll_structure_task(
    level: Res<Level>,
...
pub(crate) fn poll_gen_lod_queue(
    mut commands: Commands,
